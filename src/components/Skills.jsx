    ...
    return (
        <div id={'skills'} className={'w-full h-screen bg-[#0a192f] text-gray-300'}>
            ...
            <div className={'max-w-[1000px] mx-auto p-4 flex flex-col justify-center w-full h-full'}>
                ...
                <div className='w-full grid grid-cols-2 sm:grid-cols-3 gap-x-4 gap-y-8 sm:gap-x-6 text-center py-8'>
                    ...
                    <div className='w-40 h-40 shadow-md shadow-[#040c16] hover:scale-110 duration-500'>
                        <div className='flex flex-col justify-center items-center h-full'>
                            <img className='w-20 mx-auto px-2' src={Kotlin} alt='Kotlin Logo'/>
                    ...
                    <div className={'w-40 h-40 shadow-md shadow-[#040c16] hover:scale-110 duration-500 '}>
                        <div className='flex flex-col justify-center items-center h-full'>
                            <img className='w-20 mx-auto px-3' src={Firebase} alt='Firebase Logo'/>
